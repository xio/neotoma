...
.PHONY	: check clean clean-deps clean-docs clean-dist clean-test compile \
	  dialyzer default docs prereqs test validate veryclean xref
...
clean-dist ::
	$(RM) -f $(prj_dir)/neotoma

clean-test ::
	$(REBAR3) as test clean
	$(RM) -f $(prj_dir)/test_parser.*
...
escript :: prereqs
	...
	$(CP) _build/prod/bin/neotoma $(prj_dir)/neotoma
...
veryclean :: clean clean-docs clean-dist clean-test clean-deps
	$(RM) -rf $(cache)
